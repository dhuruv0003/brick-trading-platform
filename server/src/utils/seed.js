    ...
    const products = await Product.insertMany([
      {
        ...
        pricing: { retail: 8.5, wholesale: 7.8, bulk: 7.2, unit: 'per brick', type: 'per_brick' },
        images: [{ url: 'https://images.unsplash.com/photo-1590069261209-f8e9b8642343?auto=format&fit=crop&q=80&w=800', alt: 'Premium Wire Cut Brick', isPrimary: true }],
        inStock: true,
        isFeatured: true,
      ...
      },
      {
        ...
        pricing: { retail: 5.5, wholesale: 4.8, bulk: 4.2, unit: 'per brick', type: 'per_brick' },
        images: [{ url: 'https://images.unsplash.com/photo-1590247813693-5673b39b9a2c?auto=format&fit=crop&q=80&w=800', alt: 'Table Mould Brick', isPrimary: true }],
        inStock: true,
        isFeatured: true,
      ...
      },
      {
        ...
        pricing: { retail: 6.5, wholesale: 5.8, bulk: 5.2, unit: 'per brick', type: 'per_brick' },
        images: [{ url: 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&q=80&w=800', alt: 'Fly Ash Brick', isPrimary: true }],
        inStock: true,
        isFeatured: true,
      ...
      },
      {
        ...
        pricing: { retail: 18000, wholesale: 16000, bulk: 14500, unit: 'per 1000 bricks bundle', type: 'bundle_1000' },
        images: [{ url: 'https://images.unsplash.com/photo-1489493887464-892be6d1daae?auto=format&fit=crop&q=80&w=800', alt: 'Fire Brick', isPrimary: true }],
        inStock: true,
        isFeatured: false,
      ...
      },
      {
        ...
        pricing: { retail: 28, wholesale: 24, bulk: 20, unit: 'per piece', type: 'per_brick' },
        images: [{ url: 'https://images.unsplash.com/photo-1517581177684-8777137abe97?auto=format&fit=crop&q=80&w=800', alt: 'Hollow Block', isPrimary: true }],
        inStock: true,
        isFeatured: false,
    ...
    await Project.insertMany([
      {
        ...
        images: [{ url: 'https://images.unsplash.com/photo-1541976590-713941681591?auto=format&fit=crop&q=80&w=1200', alt: 'Greenfield Township', isPrimary: true }],
      ...
      },
      {
        ...
        images: [{ url: 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&q=80&w=1200', alt: 'School Expansion', isPrimary: true }],
